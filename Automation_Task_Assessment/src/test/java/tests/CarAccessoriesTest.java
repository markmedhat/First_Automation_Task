...
public class CarAccessoriesTest extends TestBase {
	...
	public void TaskOne_FirstScenario() {
		...
		carAccessoriesPage.waitAnElementUntillBeClickable(carAccessoriesPage.firstElement);
		...
		Assert.assertEquals(cartPage.getTextFromAddedItem(cartPage.titleOfAddItem), cartPage.checkcart());
