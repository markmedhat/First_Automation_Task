...
public class TodayDealsTest extends TestBase {
	...
	public void TaskOne_SecondScenario() {
		...
		todayDealsPage.select_unitedstate_deliverycountry();
		...
		todayDealsPage.waitAnElementUntillBeClickable(todayDealsPage.filter_items);
		todayDealsPage.Take_List_String_To_Select_An_Item(todayDealsPage.filter_items,"Grocery");

		todayDealsPage.waitAnElementUntillBeClickable(todayDealsPage.AvailableItems);
		todayDealsPage.Take_List_String_To_Select_An_Item(todayDealsPage.AvailableItems,"Available");
		// - from the discount part choose "10% off or more"
		todayDealsPage.waitAnElementUntillBeClickable(todayDealsPage.descountPercentage);
		todayDealsPage.Take_List_String_To_Select_An_Item(todayDealsPage.descountPercentage,"10% off or more");
...
//		todayDealsPage.clickOnten_percentage_descount();
	...
	//	itemDetailsPage.waitAnElementUntillBeClickable(itemDetailsPage.element);
		...
		todayDealsPage.waitAnElementUntillBeClickable(todayDealsPage.element);
